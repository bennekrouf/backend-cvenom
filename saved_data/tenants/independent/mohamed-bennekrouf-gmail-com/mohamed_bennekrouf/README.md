# CV Data for mohamed_bennekrouf

This directory contains CV data for mohamed_bennekrouf.
...
```bash
cargo run -- generate mohamed_bennekrouf en
```

Generate CV in French:
```bash
cargo run -- generate mohamed_bennekrouf fr
```
