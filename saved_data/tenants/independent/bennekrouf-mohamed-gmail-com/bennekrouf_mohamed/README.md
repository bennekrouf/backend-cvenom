# CV Data for bennekrouf_mohamed

This directory contains CV data for bennekrouf_mohamed.
...
```bash
cargo run -- generate bennekrouf_mohamed en
```

Generate CV in French:
```bash
cargo run -- generate bennekrouf_mohamed fr
```
