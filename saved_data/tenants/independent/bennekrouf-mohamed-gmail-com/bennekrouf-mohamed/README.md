# CV Data for bennekrouf-mohamed

This directory contains CV data for bennekrouf-mohamed.
...
```bash
cargo run -- generate bennekrouf-mohamed en
```

Generate CV in French:
```bash
cargo run -- generate bennekrouf-mohamed fr
```
